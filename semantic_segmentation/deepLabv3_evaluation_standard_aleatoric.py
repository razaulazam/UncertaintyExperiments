...
import shutil
from deepLabv3_standard_aleatoric import DeepLab
from helper_functions_deepLabv3 import AverageMeter, compute_aleatoric_uncertainty
...
epoch_load = 221
batch_size = 4
forward_pass = 'standard_aleatoric'
...
curr_dir = os.getcwd()
result_dir = 'deepLabv3_%s_evaluation' % forward_pass
tensor_dir = 'deepLabv3_%s_evaluation_store_tensor' % forward_pass
...
restore_from = 'deepLabv3_training_standard_aleatoric_resnet'
...
with open('mIou_deepLabv3_%s_evaluation' % forward_pass, 'w') as summary:

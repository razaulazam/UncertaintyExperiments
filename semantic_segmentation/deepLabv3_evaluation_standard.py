...
from helper_functions_deepLabv3 import AverageMeter
...
epoch_load = 225
batch_size = 4
forward_pass = 'standard_separable'
...
restore_from = 'deepLabv3_training_standard_pretrained_resnet_separable'
...
with open('mIou_deepLabv3_%s_evaluation.txt' % forward_pass, 'w') as summary:

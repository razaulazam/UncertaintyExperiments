...
save_model_checkpoints = curr_dir + '/PSPNet_training_zoom_8_pixel_wise_101'
log_dir_tensor_board = curr_dir + '/PSPNet_training_logs_zoom_8_pixel_wise_101'
...
for epochs in range(start_epoch, total_epochs):
    ...
    if miou > best_miou:
        ...
        summary_filename = os.path.join(curr_dir, 'summary_PSPNet_zoom_8_pixel_wise_101.txt')

...
from helper_functions_PSPNet import mc_dropout, AverageMeter, compute_aleatoric_uncertainty
from helper_functions_PSPNet import compute_aleatoric_uncertainty_class_average
from helper_functions_PSPNet import compute_epistemic_uncertainty, intersectionAndUnionGPU, colored_labels
from helper_functions_PSPNet import colored_annotations
...
mc_samples = 0
batch_size = 4
forward_pass = 'no_spatial_AleaEpis'
layers = 50
drop_rate = 0.5
...
curr_dir = os.getcwd()
result_dir = 'PSPNet_evaluation_%s_%.1f_%s' % (forward_pass, drop_rate, name_evaluation)
tensor_dir = 'PSPNet_evaluation_store_tensor_%s_%.1f_%s' % (forward_pass, drop_rate, name_evaluation)
...
restore_from = 'PSPNet_training_zoom_%d_pixel_wise_%d_%.1f_ND' % (zoom_factor, layers, drop_rate)
...
net = PSPNet(layers=layers, layer_drop=drop_rate)
...
with open('mIou_PSPNet_evaluation_%s_%.1f_%s' % (forward_pass, drop_rate, name_evaluation), 'w') as summary:

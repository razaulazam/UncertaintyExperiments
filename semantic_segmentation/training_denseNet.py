...
from train_data_loader_denseNet import train_loader
...
from helper_functions_denseNet import poly_learning_rate, intersectionAndUnionGPU, init_weights
...
save_model_checkpoints = curr_dir + '/denseNet_training'
log_dir_tensor_board = curr_dir + '/denseNet_training_logs'
...
for epochs in range(start_epoch, total_epochs):
    ...
    if miou > best_miou:
        ...
        summary_filename = os.path.join(curr_dir, 'summary_denseNet.txt')

...
import shutil
from PSPNet_wd_baseline import PSPNet
...
curr_dir = os.getcwd()
result_dir = 'PSPNet_%s_evaluation' % (forward_pass)
tensor_dir = 'PSPNet_%s_evaluation_store_tensor' % (forward_pass)
...
restore_from = 'PSPNet_training_zoom_%d_pixel_wise_50_standard' % zoom_factor
...
with open('mIou_PSPNet_evaluation_%s' % (forward_pass), 'w') as summary:

...
from helper_functions_deepLabv3 import heteroscedastic_loss_classification_not_vectorized, AverageMeter
...
save_model_checkpoints = curr_dir + '/deepLabv3_training_standard_aleatoric_%s' % backbone
log_dir_tensor_board = curr_dir + '/deepLabv3_training_logs_standard_aleatoric_%s' % backbone
...
for epochs in range(start_epoch, total_epochs):
    ...
    if miou > best_miou:
        ...
        summary_filename = os.path.join(curr_dir, ('summary_deepLabv3_standard_aleatoric_%s.txt' % backbone))
